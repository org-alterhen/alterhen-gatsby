...
export const LogoIcon = ({ className }) => (
  <span className={`logo-icon ${className}`}>
    ...
    <rect x="29.335" y="39.1686" width="46.6667" height="306.01" transform="rotate(-40.5456 29.335 39.1686)" fill="currentColor"/>
    <rect x="272" width="46.6667" height="272" transform="rotate(90 272 0)" fill="currentColor"/>
    <rect x="272" y="106.665" width="46.6667" height="272" transform="rotate(90 272 106.665)" fill="currentColor"/>
    <rect x="272" y="225.333" width="46.6667" height="272" transform="rotate(90 272 225.333)" fill="currentColor"/>
